...
<body>
    <header>
        <nav>
            <div class="left">Sulav's Portfolio</div>
            <div class="right">
                <ul>
    ...
    <main>
        ...
        <section class="firstSection" id="home">
            <div class="leftSection">
                Hi, My name is <span class="pink">Sulav Shrestha</span>
                <div>and I am a</div>
                ...
                <a href="https://github.com/Sulav306" target="_blank" class="btn-download">
                    View Github
                </a>
            </div>
            <div class="rightSection">
                <img src="${pageContext.request.contextPath}/images/team/sulav.jpg" alt="image">
            </div>
        </section>
        <hr>
        ...
        <section class="secondSection" id="education">
            <div>
                ...
                <div class="edu-item">
                    ...
                    <p>High School, GPA: 3.60</p>
                    <a href="https://www.xa.edu.np/">xa.edu.np</a>
                </div>

                <div class="edu-item">
                    <h3>Kathmandu Meridian School </h3>
                    <p>SEE, GPA: 3.35</p>
                    <a href="https://kms.edu.np/">gems.edu.np</a>
                </div>
            </div>
            <div class="image">
            ...
            <div class="projects_container">
                <div class="project_card">
                    <div class="project_image">
                    	<a href="https://github.com/Sulav306/Ecommerce-Website-Year-1-IS-Project" target="_blank">
                ...
                <div class="project_card">
                    <div class="project_image">
                    	<a href="https://github.com/Sulav306/Retail-Sales-and-Stock-Management-System-Year-1-Python-Project" target="_blank">
